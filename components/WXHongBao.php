 ...
 * 
 * V2.1 2016-5-28
 * 2.0可能对某些发送红包失败的情形返回true 微信服务端返回的异常结果进行了一些完善2.0   
 * 
 */

class WXHongBao{
    
    private $mch_id = "1350643001";//商户ID写死
    private $wxappid = "wxcbfa7f22b7956568";//微信公众号，写死
    private $client_ip = "112.126.67.205"; //调用红包接口的主机的IP,服务端IP,写死，即脚本文件所在的IP
    private $apikey = "dahrhjpki98mbti5hqdol721iadown01";//pay的秘钥值
    private $total_num = 1;//发放人数。固定值1，不可修改    
    private $nick_name = "唐人秀"; //红包商户名称
    private $send_name = "唐人秀";//红包派发者名称
    private $wishing = "拉票抽红包"; //    
    ...
    function __construct(){
        ...
        $this->apiclient_cert = getcwd()."/../components/WxPay/cert/apiclient_cert.pem";
        $this->apiclient_key = getcwd()."/../components/WxPay/cert/apiclient_key.pem";
    }
